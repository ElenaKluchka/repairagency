    ...
    <form action="${path }/do/signup" method="post" style= "width: 300px">
       <input type="hidden" id="filfI" name="command" value="Signup">
        ...
        <div class="container">
            ...
            <label for="uname">
            <b>Username</b></label>             
             <input type="text"  value="${newCustomer.name }" placeholder="Enter Username" name="uname" maxlength="45" required> 
            
      <!--      <input type="text" placeholder="Enter Username" name="uname" value="${newCustomer.name }">  -->
            
              <label for="email"><b>Email</b></label>
             <input type="email" value="${newCustomer.email }" placeholder="Enter email" name="email" minlength="3" maxlength="20" required> 
            
    <!--        <input type="text" placeholder="Enter email" name="email" value="${newCustomer.email }">-->
            
            <label for="phone">Phone in format +380(xx)xxx-xx-xx</label>
     <!--          <input id="online_phone" type="tel" name="phone" value="${newCustomer.phone }"> -->
        ...
        <input type="password" placeholder="Enter Password" name="psw" required minlength="6" maxlength="15">
